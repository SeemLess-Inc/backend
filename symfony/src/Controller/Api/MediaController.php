...
/**************************** GET ************************/
     ...
     *
     *
     * @Route("/Api/GetVideos", methods={"POST"})
     * @return mixed
     */
    public function getVideos()
    {
        ...
        $response = $this->forward('App\Controller\VideosController::getVideos', $fileInfo);
     ...
     *
     *
     * @Route("/Api/GetClips", methods={"POST"})
     * @param Request $request
     * @return mixed
     */
    public function getClips(Request $request)
    {
        ...
        $response = $this->forward('App\Controller\AdPodsController::getClip', $fileInfo);
